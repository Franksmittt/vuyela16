  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      ...
      <div className="w-full bg-[#1a1a1a] flex flex-col" style={{ minHeight: 'calc(100vh - 4rem)' }}>
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-linear-to-br from-[#2a2a2a]/50 to-[#1a1a1a]/70 pointer-events-none" />
          </div>
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
      >
        <div className="absolute inset-0 bg-linear-to-br from-[#2a2a2a]/50 to-[#1a1a1a] pointer-events-none" />
        <div className="container px-4 sm:px-6 relative z-10 max-w-full">
